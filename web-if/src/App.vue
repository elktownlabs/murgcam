<template>
  <v-app>
    <v-app-bar dense app v-if="this.$store.getters.isAuthenticated">
      ...
      <v-btn to="/frequency" class="mx-1 hidden-sm-and-down" dark color="primary"><v-icon>mdi-clock-fast</v-icon><span>Photo Freq.</span></v-btn>
      <v-btn to="/settings" class="mx-1 hidden-sm-and-down" dark color="primary"><v-icon>mdi-cogs</v-icon><span>Settings</span></v-btn>
      <div class="mx-3"></div>
